...
public class AppTest {
    ...
    public void runTest() throws Exception {
        FileInputStream fis = new FileInputStream("C:\\Users\\Kiruthika U\\Downloads\\stDay9cex2\\cex2\\src\\ExcelSheet\\Loan.xlsx");
        ...
        WebElement calc = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"footer\"]/div/div[1]/div/div[1]/div[2]/div[3]/a[2]")));
        calc.click();
        WebElement top = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/div[2]/h1")));
